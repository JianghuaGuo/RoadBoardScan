...
public final class CameraManager {
	 ...
	 * {@link com.youche.android.driver.zxing.CaptureActivity}
	 */
	...
	public synchronized void requestPreviewFrame(Handler handler, int message) {
		...
		if (theCamera != null && previewing) {
			...
			theCamera.setOneShotPreviewCallback(previewCallback); // 当下一幅预览图像可用时调用一次onPreviewFrame，这种方式只会回调一次，不管成功还是失败  
			//theCamera.setPreviewCallback(previewCallback); 显示一个新的预览帧时调用onPreviewFrame方法 这种方式会不会一直回调呢？
		}
	}
